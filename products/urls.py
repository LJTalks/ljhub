...
urlpatterns = [
    ...
    path('products/<slug:slug>/', views.product_summary, name='product_summary'), # Product summary view
    path('purchase/<int:product_id>/', views.purchase_product, name='purchase_product'),  # purchase product view
    path('products/<slug:slug>/detail/', views.product_detail, name='product_detail'),  # Product detail view
